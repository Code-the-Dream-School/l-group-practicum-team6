...
function LandingPage() {
  return (
    <main className="min-h-screen bg-slate-950 text-white">
          ...
          <div className="flex justify-center pt-10 pb-6 text-center">
            <div className="max-w-5xl py-10">
              ...
              <p className="mx-auto mt-6 max-w-3xl text-lg leading-8 text-white/60 md:text-xl">
                Experience the future of audio visualization with AI-generated,
                real-time reactive visuals that dance to every beat.
              </p>
      ...
      <section
        id="features"
        className="mx-auto grid max-w-5xl gap-6 px-6 py-20 md:grid-cols-3"
      >
        <div className="rounded-3xl border border-white/10 bg-white/[0.04] p-6 shadow-[0_0_40px_rgba(15,23,42,0.35)] backdrop-blur transition hover:-translate-y-1 hover:border-cyan-300/30 hover:shadow-[0_0_50px_rgba(34,211,238,0.12)]">
          ...
          <p className="mt-3 text-slate-300">
            Experience zero-latency frequency mapping that breathes with your
            music perfectly.
          </p>
        </div>
        ...
        <div className="rounded-3xl border border-white/10 bg-white/[0.04] p-6 shadow-[0_0_40px_rgba(15,23,42,0.35)] backdrop-blur transition hover:-translate-y-1 hover:border-cyan-300/30 hover:shadow-[0_0_50px_rgba(34,211,238,0.12)]">
          ...
          <p className="mt-3 text-slate-300">
            Capture live performances or environmental sound and watch it
            transform instantly.
          </p>
        </div>
        ...
        <div className="rounded-3xl border border-white/10 bg-white/[0.04] p-6 shadow-[0_0_40px_rgba(15,23,42,0.35)] backdrop-blur transition hover:-translate-y-1 hover:border-cyan-300/30 hover:shadow-[0_0_50px_rgba(34,211,238,0.12)]">
          ...
          <p className="mt-3 text-slate-300">
            Curate sets of visual presets and audio tracks for seamless
            transitions during your set.
          </p>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-5xl px-6 pb-24 text-center">
        ...
        <h2 className="mt-3 text-3xl font-semibold">
          From audio to visuals in three steps
        </h2>
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-3">
          <div className="rounded-2xl border border-white/10 bg-white/[0.04] p-6 text-left">
            ...
            <p className="mt-3 text-sm leading-6 text-white/50">
              Plug in a microphone, line-in, or virtual audio source. Sonix
              picks up the signal instantly — no plugins, no setup beyond
              choosing your input.
            </p>
          </div>
          ...
          <div className="rounded-2xl border border-white/10 bg-white/[0.04] p-6 text-left">
            ...
            <p className="mt-3 text-sm leading-6 text-white/50">
              Browse the curated library of reactive visuals. Switch between
              them instantly, shuffle for variety, and find the one that fits
              your sound.
            </p>
          </div>
          ...
          <div className="rounded-2xl border border-white/10 bg-white/[0.04] p-6 text-left">
            ...
            <p className="mt-3 text-sm leading-6 text-white/50">
              Watch your audio render live. Go fullscreen for performances and
              streams, or save the visuals you love to your favorites.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="border-t border-white/5 bg-[radial-gradient(circle_at_center,rgba(124,58,237,0.18),transparent_40%)] px-6 py-24">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-white/50">
            Sign up free and start visualizing in minutes - pick an audio
            source, choose a visual, and press play.
          </p>
