...
export default function VisualInfoCard({ name, tags }: VisualInfoCardProps) {
  const categoryLabel = tags[0] ? formatTagLabel(tags[0]) : 'Visualizer';

  return (
    <div
      className="pointer-events-none absolute bottom-[88px] left-4 z-5 w-[200px] rounded-xl border border-[#2a2a3d]/80 bg-[#1c1c28]/90 p-4 backdrop-blur-sm"
